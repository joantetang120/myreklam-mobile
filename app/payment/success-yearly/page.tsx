...
export default function SuccessYearlyPage() {
  const router = useRouter()

  useEffect(() => {
    localStorage.setItem("subscriptionType", "annuel")
    ...
    toast.success("Paiement réussi !", {
      description: "Votre abonnement Premium Annuel (59.90€/an) a été activé. Vous économisez 22.90€ !",
      duration: 5000,
    })

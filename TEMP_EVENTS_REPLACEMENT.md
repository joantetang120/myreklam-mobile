# Code à remplacer dans /announcements/events/[announcementId]/page.tsx

## Remplacer les lignes 1016-1082 par :
...
## ATTENTION:
Le problème avec `useState` dans le map: Remplacer `const [imageError, setImageError] = useState(false)` par une gestion d'erreur simple sans state.

...
class MonProfilParticulierScreen extends StatefulWidget {
  ...
  @override
  State<MonProfilParticulierScreen> createState() => _MonProfilParticulierScreenState();
}

class _MonProfilParticulierScreenState extends State<MonProfilParticulierScreen> with SingleTickerProviderStateMixin {
    ...
    try {
      ...
      if (response['profile'] != null) {
        ...
        setState(() {
          ...
          _showEmailPublic = profile['show_email_public'] == 1;
          _showPhonePublic = profile['show_phone_public'] == 1;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildCheckboxTile('Afficher sur le profil public', _showEmailPublic, (val) {
          ...
          _buildCheckboxTile('Afficher sur le profil public', _showPhonePublic, (val) {
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildSocialField('facebook', _facebookController, Icons.facebook, const Color(0xFF1877F2)),
          const SizedBox(height: 12),
          _buildSocialField('instagram', _instagramController, Icons.camera_alt_outlined, const Color(0xFFE4405F)),
          const SizedBox(height: 12),
          _buildSocialField('LinkedIn', _linkedinController, Icons.link_outlined, const Color(0xFF0A66C2)),
          const SizedBox(height: 12),
          _buildSocialField('Youtube', _youtubeController, Icons.play_circle_outline, const Color(0xFFFF0000)),
          const SizedBox(height: 12),
          _buildSocialField('Snapchat', _snapchatController, Icons.chat_bubble_outline, const Color(0xFFFEE101)),
          const SizedBox(height: 24),
  ...
  Widget _buildMediaUploadBox() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Icon(Icons.add_photo_alternate_outlined, color: const Color(0xFF3AAE5E).withOpacity(0.6)),
          const SizedBox(height: 8),
          Text(
            'Ajouter un média',
            style: TextStyle(

                ...
                child: InkWell(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const ManagedAccountsScreen(),
                      ),
                    );
                  },
                  borderRadius: BorderRadius.circular(16),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 2),
                              Text(
                                'Comptes auxquels vous avez accès',
                                style: TextStyle(
                                  fontSize: 11,
                                  color: Colors.grey[500],
                                ),
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                Switch(
                                  value: _bioEnabled,
                                  activeColor: const Color(0xFFE7412A),
                                  onChanged:
                                      _bioBusy ? null : _toggleBiometric,
                                ),
                              ],
                            ),
                          ),

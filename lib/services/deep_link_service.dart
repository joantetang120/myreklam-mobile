    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => ProPostDetailScreen(
          ...
          deliveryInfo: _buildDelivery(
            data['pickup_methods'] as Map<String, dynamic>?,
          ),
        ),
      ),
    );
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => TrainingDetailScreen(
          trainingId: id,
          companyLogo:
              user?['avatar_url']?.toString() ?? 'assets/images/Formation.png',
          companyName:
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (_) => EventDetailScreen(
          ...
          timeAgo: _timeAgo(data['created_at']?.toString()),
          eventDate:
              data['start_date']?.toString() ?? data['event_date']?.toString(),
          coverageArea:
              data['coverage_area']?.toString() ?? data['location']?.toString(),
          locationCity: data['location_city']?.toString(),
          locationPostalCode: data['location_postal_code']?.toString(),
          isOwner: data['user_id']?.toString() == UserSession().id,
          eventData: data,
